...
import { isVisibleRecievedMessage, MainComponent } from "../main-component/main.component";
...
export class TableComponent implements OnInit {
	...
	constructor(public stateService: StateService, public socketService: SocketService, public router: Router) {
		...
		this.stateService.scoresVisible.subscribe((value: isVisibleRecievedMessage) => {
